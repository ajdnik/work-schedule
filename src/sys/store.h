...
template<class T>
class Store : public QAbstractListModel, public ErrorHandler
{
private:
...
public:
    Store(DatabaseManager *manager, Error *error, QObject *parent = 0)
    ...
    Error *add(const T &object, int id)
    {
        if(id < 0)
