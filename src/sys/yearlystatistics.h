#ifndef YEARLYSTATISTICS_H
#define YEARLYSTATISTICS_H
...
class YearlyStatistics : public QObject
{
    Q_OBJECT
...
public:
    YearlyStatistics(WorkerStore *workers, QObject *parent = 0);
    int size() const;
